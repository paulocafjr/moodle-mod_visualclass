...
/**
 * This file defines mod_visualclass strings for en
 *
 * @package    mod
...
$string['felem_file_help'] = 'Uploads the archive containing GeraHTML '
    . 'output for the desired Visual Class course';
$string['felem_grades'] = 'Grade Policy';
...
$string['felem_time'] = 'Time Policy';
$string['felem_time_unit'] = 'minutes';
...
$string['modulename_help'] = '<h4 style="text-align:center;">Visual Class</h4>'
    . '<p style="text-align:justify;">Visual Class is a brazilian authorship '
    . 'software, developed by Caltech Informática Ltda, for rich muldimedia '
    . 'courses creation.</p>'
    . '<p style="text-align:justify;">This actvity module allows the use of '
    . 'such courses on Moodle. For so, it is necessary to utilize a tool '
    . 'called GeraHTML, which converts Visual Class courses into Web scripts.'
    . '</p>'
    . '<p style="text-align:justify;">For more information about Visual Class '
    . 'and other solutions go to <a href="http://www.class.com.br">class.com.'
    . 'br.</a></p>'
...
$string['report_headerdetailed'] = 'Detailed Student Report';
$string['report_headerquestion'] = 'Detailed Question Report';
$string['report_iscorrect'] = 'correct';
$string['report_iswrong'] = 'wrong';
$string['report_name'] = 'name';
$string['report_pagetitle'] = 'Screen Code';
$string['report_percent'] = 'Correct Answers (%)';
$string['report_percentcorrect'] = 'Correct Answers';
$string['report_percenttotal'] = 'Total';
$string['report_percentwrong'] = 'Wrong Answers';
$string['report_question'] = 'Question';
$string['report_separator'] = ' or ';
$string['report_time'] = 'Time';
$string['report_time_unit'] = 'Time (minutes)';
$string['report_timezero'] = 'Less than a minute';
$string['report_totalscore'] = 'Grade';
...
$string['text_adminprivileges4'] = 'Detailed by Question Report - Click in the button bellow to export as xlsx';
...
$string['xlsx_type'] = 'type';
$string['xlsx_question'] = 'question';
$string['xlsx_answercorrect'] = 'correct answer';
$string['xlsx_answeruser'] = 'user answer';
$string['xlsx_percent'] = 'correct answers (%)';
$string['xlsx_percentcorrect'] = 'correct answers';
$string['xlsx_percenttotal'] = 'total';
$string['xlsx_percentwrong'] = 'wrong answers';
$string['xlsx_totalscore'] = 'grade';
$string['xlsx_time'] = 'time (seconds)';