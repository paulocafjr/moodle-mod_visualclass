...
$string['report_time_unit'] = 'Tempo (minutos)';
...
$string['text_adminprivileges4'] = 'Relatório Detalhado por Questão - Clique no botão abaixo para exportar em xlsx';
...
$string['xlsx_type'] = 'tipo exercicio';
$string['xlsx_question'] = 'enunciado';
$string['xlsx_answercorrect'] = 'resposta correta';
$string['xlsx_answeruser'] = 'resposta usuario';
$string['xlsx_percent'] = 'respostas corretas (%)';
$string['xlsx_percentcorrect'] = 'respostas corretas';
$string['xlsx_percenttotal'] = 'total';
$string['xlsx_percentwrong'] = 'respostas erradas';
$string['xlsx_totalscore'] = 'nota';
$string['xlsx_time'] = 'tempo (segundos)';